...
-- -----------------------------------------------------------------------------
-- 1. Table datas : dataset de référence du modèle (features + cible réelle)
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS datas (
    ...
    -- Cible du dataset (0 = reste, 1 = a quitté)
    a_quitte_l_entreprise           INTEGER
);

CREATE INDEX IF NOT EXISTS ix_datas_id ON datas (id);


-- -----------------------------------------------------------------------------
-- 2. Table inputs : caractéristiques envoyées à l'API pour une prédiction
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 3. Table outputs : résultat du modèle, lié 1–1 à un input
-- -----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS outputs (
    ...
    created_at                      TIMESTAMPTZ    NOT NULL DEFAULT NOW(),
    -- Une prédiction par requête input (contrainte d'unicité)
